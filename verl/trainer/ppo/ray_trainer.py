...
class RayPPOTrainer:
    ...
    def _dump_generations(self, inputs, outputs, gts, scores, reward_extra_infos_dict, dump_path, attacker_outputs=None):
        ...
        base_data = {
            ...
            "gts": gts,
            "score": scores,
            "attacker_output": attacker_outputs,
    ...
    def _maybe_log_val_generations(self, inputs, outputs, scores, attacker_outputs=None):
        ...
        if attacker_outputs is not None and len(attacker_outputs) > 0:
            samples = [sample + (attacker_outputs[i],) for i, sample in enumerate(samples)]
