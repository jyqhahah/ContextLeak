...
# ---- decoupled remote target (Qwen3.5 cc_like on another GPU) ----
...
CUDA_VISIBLE_DEVICES=${TRAIN_GPU:-0} python3 -m recipe.dapo.main_dapo \
    ...
    actor_rollout_ref.rollout.gpu_memory_utilization=${GPU_MEM_UTIL:-0.80} \
